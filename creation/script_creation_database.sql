...
CREATE TABLE outils_developpement(
   Id_outils_developpement SERIAL,
   nom_outil VARCHAR(50) ,
   PRIMARY KEY(Id_outils_developpement)
);
...
CREATE TABLE projet(
   ...
   Id_cycle_vie_projet INTEGER NOT NULL,
...
CREATE TABLE information_technique(
   ...
   Id_outils_developpement INTEGER,
   Id_langage_developpement INTEGER,
   PRIMARY KEY(Id_information_technique),
   FOREIGN KEY(Id_outils_developpement) REFERENCES outils_developpement(Id_outils_developpement),
   FOREIGN KEY(Id_langage_developpement) REFERENCES langage_developpement(Id_langage_developpement)
);
...
CREATE TABLE a_des_infos_technique(
   Id_projet INTEGER,
   Id_information_technique INTEGER,
   PRIMARY KEY(Id_projet, Id_information_technique),
   FOREIGN KEY(Id_projet) REFERENCES projet(Id_projet),
...
CREATE TABLE possede_document(
   Id_projet INTEGER,
   Id_document_associe INTEGER,
   PRIMARY KEY(Id_projet, Id_document_associe),
   FOREIGN KEY(Id_projet) REFERENCES projet(Id_projet),
   FOREIGN KEY(Id_document_associe) REFERENCES document_associe(Id_document_associe)
);
